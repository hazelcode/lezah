execute at @e[type=!minecraft:armor_stand,distance=0.1..45,predicate=!steveapi:gamemode_19/creative,predicate=!steveapi:gamemode_19/spectator,nbt=!{Invisible:1b}] run summon lightning_bolt ~ ~ ~
