...
execute if score @s lezah.Craft matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"iron_leggings",Count:1b,tag:{warrior:1,display:{Name:'[{"translate":"item.lezah.warriors_leggings","italic":false}]'}}}}
