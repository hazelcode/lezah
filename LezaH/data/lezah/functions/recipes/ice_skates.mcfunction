...
execute if score @s crafteos matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"iron_boots",Count:1b,tag:{ID:17,display:{Name:'[{"translate":"item.lezah.ice_skates","italic":false}]'}}}}
