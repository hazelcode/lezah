...
execute if score @s crafteos matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"iron_chestplate",Count:1b,tag:{warrior:1,display:{Name:'[{"translate":"item.lezah.warriors_chestplate","italic":false}]'}}}}
