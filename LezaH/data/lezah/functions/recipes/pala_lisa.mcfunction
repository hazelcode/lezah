...
execute if score @s crafteos matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"stone_shovel",Count:1b,tag:{liso:1,display:{Name:'[{"translate":"item.lezah.smooth_stone_shovel","italic":false}]'}}}}
