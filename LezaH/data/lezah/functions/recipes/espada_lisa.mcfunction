...
execute if score @s lezah.Craft matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"stone_sword",Count:1b,tag:{liso:1,display:{Name:'[{"translate":"item.lezah.smooth_stone_sword","italic":false}]'}}}}
