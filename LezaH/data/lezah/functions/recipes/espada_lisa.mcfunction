...
execute if score @s crafteos matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"stone_sword",Count:1b,tag:{liso:1,display:{Name:'[{"text":"Espada de piedra lisa","italic":false}]'},"item_propose":"general"}}}
