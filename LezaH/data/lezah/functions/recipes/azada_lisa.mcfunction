...
execute if score @s crafteos matches 1.. run summon item ~ ~ ~ {Tags:["tagtemporal"],Item:{id:"stone_hoe",Count:1b,tag:{liso:1,display:{Name:'[{"translate":"item.lezah.smooth_stone_hoe","italic":false}]'}}}}
