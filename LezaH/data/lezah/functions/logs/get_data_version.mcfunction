# Oculto por ahora, ser� implementado m�s tarde
# �sta funci�n detecta la versi�n del juego
# �sto nos permitir� solucionar bugs para versiones exactas del juego
# Aprende m�s acerca de las data versions: https://minecraft.fandom.com/wiki/Data_version
